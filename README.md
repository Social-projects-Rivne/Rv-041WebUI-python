...
```
alias reston='gnome-terminal --tab -e "/home/<Your user name>/<Location of project root>/scripts/pyramidrun.sh" --tab -e "/home/<Your user name>/<Location of project root>/scripts/noderun.sh"'
```
